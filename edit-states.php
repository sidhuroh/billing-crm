...
?>
<title>Dashboard - Edit States | Billing</title>
<div style="background: #fff;">
    <div id="margin-setter2">
        <div style="padding: 20px;">
            <f style='font-size: 18px; font-weight: 700; color: #555;'>Edit States</f>
        </div>
    </div>
        ...
        <div style='background: #fff; margin-right: auto; margin-left: auto; max-width: 800px; border-radius: 8px; border: 2px solid #eee;'>
            <div style='padding: 20px;'>
                ...
                if ($update_btn) {
                    ...
                    if ($states_title) {
                        $sql = "UPDATE `states` SET `name`='$states_title' WHERE id='$states_id'";
                        $query = mysqli_query($conn, $sql);
                        echo "<meta http-equiv=\"refresh\" content=\"0; url=edit-states.php?id=$states_id&&updated=1\">";
                    } else {
                        echo "<meta http-equiv=\"refresh\" content=\"0; url=edit-states.php?id=$states_id&&updated=0\">";
                    }
                }
                $report = @$_GET['updated'];
                if ($report == "1") {
                ...
                <form action='#' method='POST'>
                    <div class='flex-container2'>
                        <div style='flex-grow: 1;'>
                            <p style='font-weight: 300; font-size: 14px; color: #333;'>States Name</p>
                            <input type='text' name="states_title" placeholder="Karnataka" value="<?php echo $title; ?>" class="form_control" />
                        </div>
                    </div>

...
?>
<title>Dashboard - Create Units | Billing</title>
<div style="background: #fff;">
    <div id="margin-setter2">
        <div style="padding: 20px;">
            <f style='font-size: 18px; font-weight: 700; color: #555;'>Create Units</f>
        </div>
    </div>
            ...
            <div style='padding: 20px;'>
                ...
                if ($update_btn) {
                    ...
                    if ($unit_symbol && $unit_title) {
                        $sql = "INSERT INTO `units`(`id`, `title`, `symbol`, `status`) VALUES (null,'$unit_title','$unit_symbol','active')";
                        $query = mysqli_query($conn, $sql);
                        echo "<meta http-equiv=\"refresh\" content=\"0; url=units-config.php\">";
                    } else {
                        echo "<meta http-equiv=\"refresh\" content=\"0; url=create-units.php?id=$unit_id&&updated=0\">";
                    }
                }
                $report = @$_GET['updated'];
                if ($report == "1") {
                ...
                <form action='#' method='POST'>
                    <div class='flex-container2'>
                        <div style='flex-grow: 1;'>
                            <p style='font-weight: 300; font-size: 14px; color: #333;'>Units Symbol</p>
                            <input type='text' name="unit_symbol" placeholder="e.g KG" value="<?php echo $symbol; ?>" class="form_control" />
                        </div>
                        <div style='flex-grow: 1;'>
                            <p style='font-weight: 300; font-size: 14px; color: #333;'>Units Name</p>
                            <input type='text' name="unit_title" placeholder="e.g KILOGRAM" value="<?php echo $title; ?>" class="form_control" />
                        </div>
                    </div>

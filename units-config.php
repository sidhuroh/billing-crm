...
<div style="background: #fff;">
    <div id="margin-setter2">
        <div style="padding: 20px;">
            <f style='font-size: 18px; font-weight: 700; color: #555;'><i class="fas fa-cogs"></i> Unit Configs</f>
            <a href='create-units.php' style='margin-left: 20px; text-decoration: none; font-weight: 700; color: #fff; background: #f72585; border-radius: 4px; padding: 10px; float: right;'><i class="fas fa-plus"></i> Add New</a>
            ...
            <a href='#' style='text-decoration: none; color: #023e8a;'>Units Config</a>
        </div>
    </div>
...
-moz-box-shadow: 13px 17px 28px -20px rgba(97,97,97,0.68);'>
            ...
            <table id="customers">
                ...
                while ($rows = mysqli_fetch_assoc($result)) {
                    ...
                    <td>$symbol</td>
                    <td>$color_status</td>
                    <td><a href='edit-units.php?id=$id' style='color: #fff; background: #3a86ff; padding: 8px; margin-right: 8px; border-radius: 8px;'><i class='fas fa-edit'></i></a>
                    <a href='delete-units.php?id=$id' style='color: #fff; background: #ff006e; padding: 8px; margin-right: 8px; border-radius: 8px;'><i class='fas fa-trash'></i></a>
                    </td>
                </tr>
                ";
                ?>

            ...
            <div style='padding: 20px;'>
                ...
                if ($update_btn) {
                    ...
                    if ($gst_percent && $gst_title) {
                        $sql = "INSERT INTO `gst`(`id`, `title`, `percent`, `status`) VALUES (null,'$gst_title','$gst_percent','active')";
                        $query = mysqli_query($conn, $sql);
                        echo "<meta http-equiv=\"refresh\" content=\"0; url=gst-config.php\">";
                    } else {
                        echo "<meta http-equiv=\"refresh\" content=\"0; url=create-gst.php?id=$gst_id&&updated=0\">";
                    }
                }
                $report = @$_GET['updated'];
                if ($report == "1") {
                ...
                <form action='#' method='POST'>
                    <div class='flex-container2'>
                        ...
                        <div style='flex-grow: 1;'>
                            ...
                            <input type='text' name="gst_title" placeholder="GST 10%" value="<?php echo $title; ?>" class="form_control" />
                        </div>
                    </div>

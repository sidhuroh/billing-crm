...
<div style="background: #fff;">
    <div id="margin-setter2">
        <div style="padding: 20px;">
            ...
            ?>
                <a href='create-role.php' style='margin-left: 20px; text-decoration: none; font-weight: 700; color: #fff; background: #f72585; border-radius: 4px; padding: 10px; float: right;'><i class="fas fa-plus"></i> Add Store Manager</a>
            <?php
            } else {
            ?>
                <?php
            ...
            <div class='flex-container'>
                <div>
                    <div style='padding: 15px;'>
                        ...
                        <f style='font-size: 16px; margin-left: 20px; font-weight: 700;'>Memberships</f><br>
            ...
            <div class='flex-container'>
                <div>
                    <div style='padding: 15px;'>
                        ...
                        <p style='font-size: 40px; text-align: center; margin-left: 20px; font-weight: 700;'><?php
                                                                                                                $sql = "SELECT * FROM users WHERE NOT user_type='superadmin' AND status='active'";
                                                                                                                $query = mysqli_query($conn, $sql);
                                                                                                                $rowcount = mysqli_num_rows($query);
                                                                                                                echo $rowcount;
                                                                                                                ?></p>
                            ...
                            <div class='flex-container'>
                                ...
                                <div>
                                    <div style='padding: 15px;'>
                                        ...
                                        <f style='font-size: 16px; margin-left: 20px; font-weight: 700;'>Invoices</f><br>
                                        <p style='font-size: 40px; text-align: center; margin-left: 20px; font-weight: 700;'>
                                            <?php
                                            $sql = "SELECT * FROM invoice WHERE admin='$user'";
                                            $query = mysqli_query($conn, $sql);
                                            $rowcount = mysqli_num_rows($query);
                                            echo $rowcount;
                                            ?>

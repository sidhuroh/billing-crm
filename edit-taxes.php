...
?>
<title>Dashboard - Edit Taxes | Billing</title>
<div style="background: #fff;">
    <div id="margin-setter2">
        <div style="padding: 20px;">
            <f style='font-size: 18px; font-weight: 700; color: #555;'>Edit Taxes</f>
        </div>
    </div>
            ...
            <div style='padding: 20px;'>
                ...
                if ($update_btn) {
                    ...
                    if ($taxes_percent && $taxes_title) {
                        $sql = "UPDATE `taxes` SET `percent`='$taxes_percent',`title`='$taxes_title' WHERE id='$taxes_id'";
                        $query = mysqli_query($conn, $sql);
                        echo "<meta http-equiv=\"refresh\" content=\"0; url=edit-taxes.php?id=$taxes_id&&updated=1\">";
                    } else {
                        echo "<meta http-equiv=\"refresh\" content=\"0; url=edit-taxes.php?id=$taxes_id&&updated=0\">";
                    }
                }
                $report = @$_GET['updated'];
                if ($report == "1") {
                ...
                <form action='#' method='POST'>
                    <div class='flex-container2'>
                        <div style='flex-grow: 1;'>
                            <p style='font-weight: 300; font-size: 14px; color: #333;'>Taxes Percent</p>
                        ...
                        <div style='flex-grow: 1;'>
                            ...
                            <input type='text' name="taxes_title" placeholder="5% Tax" value="<?php echo $title; ?>" class="form_control" />
                        </div>
                    </div>
